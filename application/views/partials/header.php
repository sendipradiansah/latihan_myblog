...
<html lang="en">
  ...
  <head>
    ...
    <title>My Blog - Posting your blog</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand" href="<?php echo site_url();?>">Selamat Datang, <?php if(isset($_SESSION['nama'])): 
        echo '<span class="text-info p-2">'. $_SESSION['nama'] . '</span>'; 
        endif; ?></a>
